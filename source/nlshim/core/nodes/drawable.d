...
*/
module nlshim.core.nodes.drawable;
import nlshim.integration;
import nlshim.fmt.serialize;
import nlshim.math;
import nlshim.math.veca_ops : transformAssign, transformAdd;
import nlshim.math.triangle;
...
//        writefln("welding: %s(%b) --> %s(%b)", name, postProcessed, target.name, target.postProcessed);
    ...
    */
    public size_t deformSliceOffset;

    /**
        Offset within the shared vertex buffer
    */
    public size_t vertexSliceOffset;

    /**
        Offset within the shared UV buffer
    */
    public size_t uvSliceOffset;
