...
*/
module nlshim.core.nodes.composite.projectable;

import nlshim.core.nodes.common;
...
version (NijiliveRenderProfiler) import nlshim.core.render.profiler : profileScope;
import nlshim.core.render.commands : DynamicCompositePass, DynamicCompositeSurface, PartDrawPacket;
import nlshim.core.render.command_emitter : RenderCommandEmitter;
import nlshim.core.render.scheduler : RenderContext, TaskScheduler, TaskOrder, TaskKind;
...
protected:
    ...
    public bool dynamicScopeActive = false;
    public size_t dynamicScopeToken = size_t.max;
    public bool reuseCachedTextureThisFrame = false;
    bool hasValidOffscreenContent = false;
    bool loggedFirstRenderAttempt = false;

    public size_t dynamicScopeTokenValue() const {
