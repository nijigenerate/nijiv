...
public:
    ...
    */
    ...
    public RenderSpace currentRenderSpace(bool forceIgnorePuppet = false) {
    ...
    public mat4 immediateModelMatrix() {
...
public void setOffscreenModelMatrix(const mat4 matrix) {
    offscreenModelMatrix = matrix;
    hasOffscreenModelMatrix = true;
}

public void setOffscreenRenderMatrix(const mat4 matrix) {
    offscreenRenderMatrix = matrix;
    hasOffscreenRenderMatrix = true;
}

public bool hasOffscreenModelMatrixActive() const {
    return hasOffscreenModelMatrix;
}

public bool hasOffscreenRenderMatrixActive() const {
    return hasOffscreenRenderMatrix;
}

public mat4 offscreenRenderMatrixValue() const {
    return offscreenRenderMatrix;
}

public void clearOffscreenModelMatrix() {
    hasOffscreenModelMatrix = false;
}

public void clearOffscreenRenderMatrix() {
    hasOffscreenRenderMatrix = false;
}

public bool backendRenderable() {
    return enabled && data.isReady();
}

    public size_t backendMaskCount() {
        return maskCount();
    }

    public MaskBinding[] backendMasks() {
        return masks;
    }
