module nlshim.integration.unity;
...
import nlshim.core.animation.player : AnimationPlayer;

import nlshim : inUpdate, inSetTimingFunc;
import nlshim.core.runtime_state : initRendererCommon, inSetRenderBackend, inSetViewport, inGetViewport;
import nlshim.core.render.backends : RenderBackend, RenderResourceHandle, BackendEnum;
import nlshim.core.render.backends.queue : CommandQueueEmitter, QueuedCommand,
    RenderingBackend;
import nlshim.core.render.shared_deform_buffer :
    sharedVertexBufferData,
    sharedUvBufferData,
    sharedDeformBufferData;
import nlshim.core.texture : ngReleaseExternalHandle;
...
import nlshim.core.puppet : Puppet;
import nlshim.core.texture : Texture;
import nlshim.math : vec2, vec3, vec4, mat4;
...
private void ensureNodeFactoriesBuilt() {
    import nlshim.core.nodes.node : inInitNodes, inHasNodeType;
    ...
    import nlshim.core.param : inParameterSetFactory, Parameter;
...
extern(C) export void njgRuntimeInit() {
    ...
    import nlshim.core.nodes.node : inHasNodeType;
...
extern(C) export NjgResult njgCreateRenderer(const UnityRendererConfig* config,
    ...
    try {
        ...
        import nlshim.core.nodes.node : inInitNodes;
        inInitNodes();
        initRendererCommon();
...
extern(C) export NjgResult njgLoadPuppet(RendererHandle handle, const char* path, PuppetHandle* outPuppet) {
    ...
    try {
        ...
        import nlshim.core.nodes.node : inInitNodes;
        inInitNodes();
        import nlshim.fmt : inLoadPuppet;
